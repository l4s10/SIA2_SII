...
class SolicitudBodegas extends Model
{
    ...
    public static $rules = [
        ...
        'FECHA_ASIG_BODEGA' => 'nullable|string',
        'HORA_SOL_BODEGA' => 'nullable|string|max:128',
        'HORA_ASIG_BODEGA' => 'nullable|string|max:128',
    ...
    public static $messages = [
        ...
        'HORA_SOL_BODEGA.max' => 'La hora de solicitud no puede tener más de :max caracteres.',
