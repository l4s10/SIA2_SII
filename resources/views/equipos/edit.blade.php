    ...
    <div class="container">
        <form action="/equipos/{{route('equipos.update',$equipo->ID_EQUIPO)}}" method="POST">
            ...
            <div class="form-group">
                ...
                <select class="form-control @error('ID_TIPO_EQUIPOS') is-invalid @enderror" name="ID_TIPO_EQUIPOS" id="ID_TIPO_EQUIPOS" required>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('MARCA_EQUIPO') is-invalid @enderror" name="MARCA_EQUIPO" id="MARCA_EQUIPO" value="{{$equipo->MARCA_EQUIPO}}" placeholder="Ej: LENOVO" tabindex="2" required>
                @error('MARCA_EQUIPO')
                    <div class="invalid-feedback">{{$message}}</div>
                @enderror
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('MODELO_EQUIPO') is-invalid @enderror" name="MODELO_EQUIPO" id="MODELO_EQUIPO" value="{{$equipo->MODELO_EQUIPO}}" placeholder="GENERALMENTE ESTA EN LA BASE DEL EQUIPO" tabindex="2" required>
                @error('MODELO_EQUIPO')
                    <div class="invalid-feedback">{{$message}}</div>
                @enderror
            </div>
            <div class="form-group">
                ...
                <select name="ESTADO_EQUIPO" id="ESTADO_EQUIPO" class="form-control @error('ESTADO_EQUIPO') is-invalid @enderror" required>
