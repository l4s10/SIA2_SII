    ...
    <div class="container">
        <form action="{{route('equipos.store')}}" method="POST">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="ID_TIPO_EQUIPOS" id="ID_TIPO_EQUIPOS" required>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('MARCA_EQUIPO') is-invalid @enderror" name="MARCA_EQUIPO" id="MARCA_EQUIPO" value="{{old('MARCA_EQUIPO')}}" placeholder="Ej: LENOVO" tabindex="2" required>
                @error('MARCA_EQUIPO')
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('MODELO_EQUIPO') is-invalid @enderror" name="MODELO_EQUIPO" id="MODELO_EQUIPO" value="{{old('MODELO_EQUIPO')}}" placeholder="GENERALMENTE ESTÁ ROTULADO EN EL EQUIPO" tabindex="2" required>
                @error('MODELO_EQUIPO')
                    <div class="invalid-feedback">{{$message}}</div>
                @enderror
            </div>
