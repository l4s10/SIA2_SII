...
@section('content')
    <form action="{{route('categoriasalas.store')}}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input id="CATEGORIA_SALA" name="CATEGORIA_SALA" type="text" class="form-control @error('CATEGORIA_SALA') is-invalid @enderror" value="{{old('CATEGORIA_SALA')}}" placeholder="Ej: BODEGA" tabindex="2">
