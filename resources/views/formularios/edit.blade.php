...
<div class="container">
    <form action="{{route('formularios.update',$formulario->ID_FORMULARIO)}}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input id="NOMBRE_FORMULARIO" name="NOMBRE_FORMULARIO" type="text" class="form-control {{ $errors->has('NOMBRE_FORMULARIO') ? ' is-invalid' : '' }}" value="{{$formulario->NOMBRE_FORMULARIO}}" placeholder="Ej: 22199" tabindex="2" required>
