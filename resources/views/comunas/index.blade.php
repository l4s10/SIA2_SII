...
<div class="container">
    <form action="{{ route('materiales.store') }}" method="POST">
        @csrf
        <div class="mb-3">
            <label for="NOMBRE_MATERIAL" class="form-label"><i class="fa-solid fa-book-bookmark"></i> Nombre de la comuna:</label>
        ...
        <div class="mb-3">
            <label for="ID_TIPO_MAT" class="form-label"><i class="fa-solid fa-person-chalkboard"></i> Numero de comuna:</label>
