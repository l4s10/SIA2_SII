...
<html>
  ...
  <body>
<style>
@page { margin-left: 0.01in; margin-right: 0.01in; margin-top: 0.01in; margin-bottom: 0.01in; }
body { margin-left: 0.25in; margin-right: 0.55in; margin-top: 0.45in; margin-bottom: 0.45in; }
</style>
        ...
        <tbody>
          ...
          <tr class="row3">
            ...
            <tr class="row4">
                ...
                <td class="column3 style15 s">{{ $solicitud->created_at->day }}</td>
                <td class="column4 style15 s">{{ $solicitud->created_at->month }}</td>
                <td class="column5 style16 s">{{ $solicitud->created_at->year }}</td>
          ...
          <tr class="row32">
            ...
            <td class="column5 style68 s style68" colspan="4"></td>
          </tr>
          <tr class="row33">
          ...
          <tr class="row40">
            ...
            <td class="column1 style81 null style81" colspan="2">
                @if($solicitud->FECHA_LLEGADA_CONDUCTOR)
                    {{ \Carbon\Carbon::parse($solicitud->FECHA_LLEGADA_CONDUCTOR)->format('d/m/Y H:i') }}
                @else
                    N/A
                @endif
            </td>
          ...
          <tr class="row44">
            ...
            <td class="column1 style94 null style94" colspan="2">
                {{ $horasDiferencia ?? 'N/A' }}
            </td>
