...
@section('title', 'Solicitudes Vehiculares')

@section('content_header')
    <h1>Reparacion de Vehiculos</h1>
@stop
...
@section('content')
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="mb-3">
                <label for="OBSERVACIONES" class="form-label"><i class="fa-solid fa-car-on"></i> Motivo de solicitud:</label>
                <textarea class="form-control" aria-label="With textarea"></textarea>
            <div>
        <div class="mb-3">
            <label for="ESTADO_SOL" class="form-label"><i class="fa-solid fa-building-user"></i> Conductor:</label>
            <select id="ESTADO_SOL" name="ESTADO_SOL" class="form-control">
                <option value="OFICINA" selected>Juan</option>
                ...
                <option value="JOSE">Jose</option>
                    ...
                    <div class="mb-3">
                    <label for="DEPTO" class="form-label"><i class="fa-solid fa-road-circle-check"></i> Fecha Salida / llegada:</label>
                    <input type="text" id="DEPTO" name="DEPTO" class="form-control{{ $errors->has('DEPTO') ? ' is-invalid' : '' }}" value="{{ old('DEPTO') }}" placeholder="Aqui iria el reloj virtual">
                    @if ($errors->has('DEPTO'))
                    <div class="invalid-feedback">
                        {{ $errors->first('DEPTO') }}
                    </div>
                    ...
                    <div class="mb-3">
                    <label for="DEPTO" class="form-label"><i class="fa-solid fa-car-tunnel"></i> Hora Salida / llegada:</label>
                    <input type="text" id="DEPTO" name="DEPTO" class="form-control{{ $errors->has('DEPTO') ? ' is-invalid' : '' }}" value="{{ old('DEPTO') }}" placeholder="Aqui iria el reloj virtual">
                    @if ($errors->has('DEPTO'))
                    <div class="invalid-feedback">
                        {{ $errors->first('DEPTO') }}
            ...
            <div class="mb-3">
                <label for="OBSERVACIONES" class="form-label"><i class="fa-solid fa-users-rectangle"></i> Nombre de solicitantes:</label>
                <textarea class="form-control" aria-label="With textarea"></textarea>
            <div>
            ...
            <select id="ESTADO_SOL" name="ESTADO_SOL" class="form-control" readonly>
