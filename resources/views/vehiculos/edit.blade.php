    ...
    <form action="{{ route('vehiculos.update', $vehiculo->ID_VEHICULO) }}" method="POST">
        ...
        <div class="row">
            <div class="col">
                ...
                <input id="PATENTE_VEHICULO" name="PATENTE_VEHICULO" type="text" class="form-control" tabindex="1" placeholder="Ej: AB1234" value="{{ $vehiculo->PATENTE_VEHICULO }}" required>
        ...
        <div class="row">
            <div class="col">
                ...
                <input id="MARCA" name="MARCA" type="text" class="form-control" tabindex="3" placeholder="Toyota" value="{{ $vehiculo->MARCA }}" required>
                @error('MARCA')
                    <div class="alert alert-danger mt-2">{{ $message }}</div>
                @enderror
            </div>
            <div class="col">
                ...
                <input id="MODELO_VEHICULO" name="MODELO_VEHICULO" type="text" class="form-control" tabindex="4" placeholder="Corolla" value="{{ $vehiculo->MODELO_VEHICULO }}" required>
