...
<div class="container">
    <form action="{{ route('salas.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control{{ $errors->has('CAPACIDAD_PERSONAS') ? ' is-invalid' : '' }}" id="CAPACIDAD_PERSONAS" name="CAPACIDAD_PERSONAS" value="{{ old('CAPACIDAD_PERSONAS') }}" placeholder="10" min="0" required>
